...
_PERSONA_CHALLENGER = (
    ...
    "CROSS-CHECK NUMERIC CLAIMS (mandatory):\n"
    "- For every quantitative assertion by ANALYST, MARKETING, or FINANCE (e.g. 'Country X has the highest "
    "margin'), locate the exact value in `data_sample` or `sub_results`. If the stated value or ranking "
    "does not match the data, flag it explicitly in insight.\n"
