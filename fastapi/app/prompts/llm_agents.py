...
_PERSONA_CHALLENGER = (
    ...
    "4. If and ONLY if evidence is clearly insufficient, set needs_more_data true and propose ONE plain-English "
    "analytics sub-question (no SQL) that closes the biggest gap; otherwise needs_more_data false and null "
    "proposed_sub_question / why.\n\n"
    "BOUNDARIES:\n"
